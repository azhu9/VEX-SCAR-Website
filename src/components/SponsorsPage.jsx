...
import Onshape from "../assets/sponsors/onshape.png";

import tiers from "../assets/sponsors/tiers.png";

import { MdOutlineFileDownload } from "react-icons/md";

const sponsorData = [Onshape, Whimsy, Reng, Polymaker, Ieee, Nnl];

const SponsorsPage = () => {
  return (
    <div className=" bg-white min-h-screen">
      <div className="text-center mb-16 mx-8 pt-32">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
          Thank you to our Sponsors and Partners
        </h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          We are grateful for the support of our generous sponsors who make our
          club possible.
        </p>
      </div>
      ...
      <div className=" max-w-3xl mx-auto mt-20 pb-8">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto text-center">
          If you would like to sponsor Rutgers VEXU Robotics, contact us at
          vexu.rutgersieee@gmail.com
        </p>

        <img src={tiers} alt="" className="mx-auto" />
        <a
          className="cursor-pointer"
          href="../assets/sponsors/Sponsorship-Packet.pdf"
        ...
        >
          <div className="bg-[#1a1919] hover:bg-gray-200 duration-400 hover:text-black text-white p-3 font-geist rounded-b-lg border-black border-1 ease-in-out">
            ...
            <MdOutlineFileDownload
              className="float-right hover:text-black"
              size={25}
            />
          </div>
        </a>

      ...
      <div className="max-w-[1240px] mx-auto grid lg:grid-cols-3">
        <div className="lg:col-span-2">
          ...
          <h2 className="md:text-2xl sm:text-xl text-l font-bold py-2">Current Sponsors</h2>
            <div className="flex justify-between w-[80%] mx-auto bg-white p-4 m-4 rounded-lg " >
              <img src={Nnl} className="max-w-40" alt="/"/>
              <img src={Whimsy} className="max-w-40" alt="/"/>
              <img src={Reng} className="max-w-48"/>
            </div>
        </div>
        <div className="my-4">
          ...
          <form class="max-w-md mx-auto">
            ...
            <div class="mb-5">
              <label for="large-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Message</label>

...
import Vex1 from "../assets/carousel/vex1.webp";
import Vex2 from "../assets/carousel/vex2.webp";
import Vex3 from "../assets/carousel/vex3.webp";
import Vex4 from "../assets/carousel/vex4.webp";
    ...
    <div className="text-white">
      <div className="relative group">
        <div className="w-full h-full relative align-middle">
          <img
            className="w-full h-[calc(100vh-80px)] mt-[80px] overflow-hidden object-cover opacity-40 relative align-middle"
          ...
          <div className="title-text max-w-[800px] mt-[-96px] w-full h-[80%] mx-auto text-center flex flex-col justify-center">
            <p className="text-[#b44417] font-bold py-1">
              RUTGERS IEEE VEXU DIVISION
            </p>
            <h1 className="animate-fade md:text-7xl sm:text-6xl text-4xl font-bold">
              SCAR ROBOTICS
            </h1>
            <div>
              <a href="#info-section">
                <IoIosArrowDropdown
                  className="animate-bounce z-10 mx-auto my-8 cursor-pointer"
                  size={40}
                />
              </a>
            </div>
